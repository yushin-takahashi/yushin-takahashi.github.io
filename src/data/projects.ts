...
export const projects: Project[] = [
  {
    ...
    links: [
      ...
      { label: "Physical Review E", url: "https://journals.aps.org/pre/abstract/10.1103/9gcy-ky3z" },
  ...
  },
  {
    ...
    links: [
      { label: { ja: "論文 (PDF)", en: "Thesis (PDF)" }, url: "/docs/bachelor-thesis-2026.pdf" }
    ],
  },
  {
    id: "DEV_03",
    ...
    links: [
      { label: "Colab", url: "https://colab.research.google.com/drive/1Y5AQl7gkYdPNIqI5eN0X9Cgea98Tagxe" }
    ],
  },
  {
    id: "DEV_02",
    ...
    links: [
      { label: { ja: "URL (準備中)", en: "URL (Coming Soon)" }, url: "" }
    ],
  },
  {
    id: "DEV_01",
    ...
    links: [
      { label: { ja: "発表資料 (PDF)", en: "Slides (PDF)" }, url: "/docs/hacku-2021-fragant-slides.pdf" }
    ],
  }
];
